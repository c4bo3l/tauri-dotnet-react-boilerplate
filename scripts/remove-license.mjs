...
// ═══════════════════════════════════════════════════════════════════════════
//  6b. Remove LicensePublicKey from appsettings.json files
// ═══════════════════════════════════════════════════════════════════════════

removeLineContaining(resolve(root, 'backend/appsettings.json'), 'LicensePublicKey');
removeLineContaining(resolve(root, 'backend/appsettings.Development.json'), 'LicensePublicKey');
